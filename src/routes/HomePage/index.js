...
const SITE_URL = process.env.NODE_ENV === 'development' ? 'http://localhost:3000' : 'https://agilenix.com/';
...
class Page extends Component {
  getMetaTags({ title, description, image, contentType, noCrawl, published, updated, category, tags }, pathname) {
